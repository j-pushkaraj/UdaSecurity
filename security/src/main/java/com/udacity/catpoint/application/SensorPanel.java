...
public class SensorPanel extends JPanel implements StatusListener {
    ...
    private void updateSensorList(JPanel p) {
        ...
        securityService.getSensors().stream().sorted().forEach(s -> {
            ...
            sensorLabel.setBackground(s.getActive() ? new java.awt.Color(255, 102, 102) : new java.awt.Color(220, 220, 220));
            sensorLabel.setForeground(s.getActive() ? java.awt.Color.WHITE : java.awt.Color.BLACK);
            ...
            sensorToggleButton.setOpaque(true);
            sensorToggleButton.setBorderPainted(false);
            sensorToggleButton.setBackground(s.getActive() ? new java.awt.Color(255, 153, 153) : new java.awt.Color(240, 240, 240));
